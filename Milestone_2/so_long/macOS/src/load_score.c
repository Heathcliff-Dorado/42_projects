...
t_font	ft_load_font(t_game *g)
{
	...
	score.zero = mlx_texture_to_image(g->id, mlx_load_png("sprite/others/zero.png"));
	score.one = mlx_texture_to_image(g->id, mlx_load_png("sprite/others/one.png"));
	score.two = mlx_texture_to_image(g->id, mlx_load_png("sprite/others/two.png"));
	score.three = mlx_texture_to_image(g->id, mlx_load_png("sprite/others/three.png"));
	score.four = mlx_texture_to_image(g->id, mlx_load_png("sprite/others/four.png"));
	score.five = mlx_texture_to_image(g->id, mlx_load_png("sprite/others/five.png"));
	score.six = mlx_texture_to_image(g->id, mlx_load_png("sprite/others/six.png"));
	score.seven = mlx_texture_to_image(g->id, mlx_load_png("sprite/others/seven.png"));
	score.eight = mlx_texture_to_image(g->id, mlx_load_png("sprite/others/eight.png"));
	score.nine = mlx_texture_to_image(g->id, mlx_load_png("sprite/others/nine.png"));
